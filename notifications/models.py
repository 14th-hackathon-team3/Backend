...
#         "groups.Membership", on_delete=models.CASCADE, db_column="membership_id", related_name="notifications"
#     )
#     type = models.CharField(max_length=50, choices=NotiType.choices)
#     # 폴리모픽 참조: todos, daily_log 등 다양한 테이블을 가리킬 수 있어
...
#     read_at = models.DateTimeField(null=True, blank=True)  # NULL=안읽음, 값 있으면 읽은시각
